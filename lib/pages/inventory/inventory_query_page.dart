  ...
  Future<void> _searchInventory({bool showAll = false}) async {
    ...
    try {
      ...
      for (final factoryId in userFactoryIds) {
        ...
        safeDebugPrint(
            'Inventory count in factory $factoryId: ${inventorySnapshot.docs.length}');
        ...
        for (final invDoc in inventorySnapshot.docs) {
          ...
          if (!userProducts.containsKey(itemId)) {
            safeDebugPrint(
                'Inventory product $itemId ignored: not in user products.');
            continue;
          }
          ...
          if (!showAll &&
            ...
            safeDebugPrint(
                'Inventory product $itemId ignored: search query mismatch.');
            continue;
          }
            ...
            if (userCompanyIds.contains(companyId)) {
              ...
              if (companyData != null) {
                ...
                if (companyName.isNotEmpty) {
                  relevantCompanyNames.add(companyName);
                }
              }
            }
          }
  ...
  Widget _buildInventoryItem(Map<String, dynamic> item) {
    return Card(
      ...
      child: ListTile(
        ...
        // ✅ الحل: استخدم subtitle مع Column ولكن مع mainAxisSize: MainAxisSize.min
        subtitle: Column(
          mainAxisSize: MainAxisSize.min, // 🔑 المفتاح لحل المشكلة
        ...
        // ✅ استخدام trailing بشكل آمن
        trailing: SizedBox(
          width: 60,
          child: Column(
            mainAxisSize: MainAxisSize.min, // 🔑 مفتاح الحل
...
// ✅ دالة مساعدة مبسطة لعرض صفوف المعلومات
...
// دالة عرض تاريخ الحركات مع دعم الترجمة الكامل وأنواع حركات صحيحة
/* Future<void> _showStockHistory(String itemId, String factoryId) async {
  final user = FirebaseAuth.instance.currentUser;
  if (user == null) return;
            ...
            child: allMovements.isEmpty
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final movementType = data['type']?.toString().toLowerCase() ?? 'unknown';
                      ...
                      // ✅ تحديد نوع الحركة وعرض نص مناسب
                      final Map<String, dynamic> movementInfo = _getMovementTypeInfo(movementType, quantity);
                      final bool isAddition = movementInfo['isAddition'] as bool;
                      final String typeText = movementInfo['typeText'] as String;
                      final IconData iconData = movementInfo['icon'] as IconData;
                      final Color iconColor = movementInfo['iconColor'] as Color;
                      ...
                      return Card(
                        ...
                        child: ExpansionTile(
                          ...
                          title: Text(
                            '$typeText: ${quantity.toStringAsFixed(2)}',
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
                              color: isAddition ? Colors.green.shade700 : Colors.red.shade700,
                            ),
...
/*   Future<void> _showStockHistory(String itemId, String factoryId) async {
    ...
    try {
      ...
      // تحديد الشركات المشتركة بين المستخدم والمصنع
      final relevantCompanyIds =
          userCompanyIds.where((id) => factoryCompanyIds.contains(id)).toList();
              ...
              child: allMovements.isEmpty
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final movementType =
                            data['type']?.toString().toLowerCase() ?? 'unknown';
                        final quantity =
                        ...
                        // ✅ تحديد نوع الحركة
                        final Map<String, dynamic> movementInfo =
                            _getMovementTypeInfo(movementType, quantity);
                        final bool isAddition =
                            movementInfo['isAddition'] as bool;
                        final String typeText =
                            movementInfo['typeText'] as String;
                        final IconData iconData =
                            movementInfo['icon'] as IconData;
                        final Color iconColor =
                            movementInfo['iconColor'] as Color;
                          ...
                          child: ExpansionTile(
                            ...
                            title: Row(
                              children: [
                                ...
                                Text(
                                  '${movementInfo['sign']} ${quantity.toStringAsFixed(2)}', // ✅ استخدم movementInfo['sign']
                                  style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    color: isAddition
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if (note != null &&
                                      ...
                                      _buildInfoRow(Icons.note, 'notes'.tr(),
                                          note.toString()),
                                      const Divider(),
                                    ],
                                    if (userName != null &&
              ...
              child: allMovements.isEmpty
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final Color iconColor =
                            movementInfo['iconColor'] as Color;
                        final String sign = movementInfo['sign'] as String;
                        ...
                        return Card(
                          ...
                          child: ExpansionTile(
                            ...
                            // ✅ عرض مع علامة + أو - من movementInfo
                            title: Row(
                              children: [
                                Text(
                                  '$typeText: ',
                                ...
                                Text(
                                  '$sign ${quantity.toStringAsFixed(2)}',
                                  style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    color: isAddition
                                        ? Colors.green.shade700
...
// ✅ دالة مساعدة لتحويل نوع الحركة إلى نص وأيقونة مناسبة
/* Map<String, dynamic> _getMovementTypeInfo(String type, double quantity) {
  switch (type) {
    case 'purchase':
      return {
        'isAddition': true,
        'typeText': 'purchase'.tr(),
    ...
    default:
      return {
        ...
        'typeText': type.tr(),
        'icon': quantity > 0 ? Icons.add_circle_outline : Icons.remove_circle_outline,
        'iconColor': quantity > 0 ? Colors.green : Colors.red,
      };
  }
}
 */

/* // ✅ دالة مساعدة لتحويل نوع الحركة إلى نص وأيقونة مناسبة مع علامة +/-
  Map<String, dynamic> _getMovementTypeInfo(String type, double quantity) {
    switch (type) {
      // ✅ إضافة مخزون (علامة + باللون الأخضر)
      case 'purchase':
        return {
          'isAddition': true,
          'typeText': 'purchase'.tr(),
...
Map<String, dynamic> _getMovementTypeInfo(String type, double quantity) {
  switch (type) {
    ...
    case 'production':
      return {
        'isAddition': false,  // ✅ تصنيع يستهلك مواد خام → نقص
        'typeText': 'manufacturing'.tr(),
        'icon': Icons.factory,
        'iconColor': Colors.red,
        'sign': '-',
    ...
    default:
      // ✅ إذا كانت الكمية موجبة → إضافة، سالبة → خصم
      final isAdd = quantity > 0;
      return {
        'isAddition': isAdd,
        'typeText': type.tr(),
        'icon': isAdd ? Icons.add_circle_outline : Icons.remove_circle_outline,
        'iconColor': isAdd ? Colors.green : Colors.red,
        'sign': isAdd ? '+' : '-',
      };
  }
}
...
class _InventoryQueryPageState extends State<InventoryQueryPage> {
  ...
  Future<void> _searchInventory({bool showAll = false}) async {
    ...
    try {
      ...
      for (final factoryId in userFactoryIds) {
        ...
        for (final invDoc in inventorySnapshot.docs) {
          final itemId = invDoc.id;
          if (!userProducts.containsKey(itemId)) continue;
  ...
  // ✅ الدالة الرئيسية لعرض تاريخ الحركة
  Future<void> _showStockHistory(String itemId, String factoryId) async {
    final user = FirebaseAuth.instance.currentUser;
    if (user == null) return;
              ...
              child: allMovements.isEmpty
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        // ✅ تحديد معلومات الحركة
                        final isAddition = _isAdditionMovement(movementType);
                        final String typeText =
                            _getMovementTypeText(movementType);
/*                         final IconData iconData =
                            _getMovementIcon(movementType); */
...
/*                             leading: Icon(
  ...
  // ✅ دوال مساعدة لتحديد نوع الحركة
/*   bool _isAdditionMovement(String type) {
    switch (type) {
      case 'purchase':
      case 'return':
      case 'adjustment_in':
      case 'increase':
        return true;  // ✅ زيادة المخزون
      case 'manufacturing':
      case 'production':
      case 'issue':
      case 'consumption':
 ...
 */
  ...
  // ✅ الدالة الصحيحة لتحديد نوع الحركة
  bool _isAdditionMovement(String type) {
    switch (type) {
      // ✅ حركات تزيد المخزون (علامة + أخضر)
      case 'purchase':
      case 'return':
      case 'adjustment_in':
      case 'increase':
      ...
      default:
        // ✅ إذا كان الاسم يحتوي على كلمات تدل على النقص
        final lowerType = type.toLowerCase();
        if (lowerType.contains('out') ||
            lowerType.contains('remove') ||
            lowerType.contains('issue') ||
            lowerType.contains('consumption') ||
  ...
  String _getMovementTypeText(String type) {
    switch (type) {
      ...
      case 'adjustment_in':
        return 'adjustment_in'.tr();
      case 'adjustment_out':
        return 'adjustment_out'.tr();
      case 'waste':
        return 'waste'.tr();
      default:
        return type.tr();
